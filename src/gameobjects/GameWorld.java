...
public class GameWorld {
    ...
    public static final int finalBossX = 3600; //vị trí của con boss cuối 
    ...
    public int openIntroGameY = 0;// khi bắt đầu mởi màn hình thì khoảng cách =0
...
//        ParticularObject smallRedGun = new SmallRedGun(1250, 180, this);
...
//        darkRaise.setDirection(ParticularObject.LEFT_DIR);
//        darkRaise.setTeamType(ParticularObject.ENEMY_TEAM);
//        particularObjectManager.addObject(darkRaise);
//
//        ParticularObject darkRaise2 = new DarkRaise(1600, 3500, this);
//        darkRaise2.setDirection(ParticularObject.LEFT_DIR);
//        darkRaise2.setTeamType(ParticularObject.ENEMY_TEAM);
//        particularObjectManager.addObject(darkRaise2);
//        
//        ParticularObject darkRaise3 = new DarkRaise(3000, 650, this);
...
//        particularObjectManager.addObject(redeye);
//        
//        ParticularObject robotR2 = new RobotR2(3400, 350, this);
//        robotR2.setDirection(ParticularObject.LEFT_DIR);
