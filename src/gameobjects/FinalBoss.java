 ...
 * @author nguyen
 */
// human: đại diện cho lớp có chân tay
public class FinalBoss extends Human {
    ...
    private Hashtable<String, Long> timeAttack = new Hashtable<String, Long>();// chứa tên hành động và thời gian tương ứng với hành động đó
    private String[] attackType = new String[4];// tương tự như mảng các trạng thái hoạt động cửa quái
    private int attackIndex = 0;// index của trạng thái
    private long lastAttackTime; // xác định cái trạng thái của quoái kết thúc khi nào
    ...
    public FinalBoss(float x, float y, GameWorld gameWorld) {
        ...
        setTimeForNoBehurt(500 * 10000000);
        setDamage(10);
